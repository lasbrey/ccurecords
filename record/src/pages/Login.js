...
import Faceid from "../components/faceid.svg";
  ...
  return (
    <div className=" App lg:flex">
      <div className="lg:w-1/2 xl:max-w-screen-sm">
        <div className="py-12 bg-yellow-100 lg:bg-white flex justify-center lg:justify-start px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-14 xl:px-24 xl:max-w-2xl">
          <div className="cursor-pointer flex items-center">
            <div> </div>
            <div className="text-2xl text-yellow-800 tracking-wide font-semibold">
              CCURECORDS
            </div>
          </div>
        </div>
        <div className="mt-8 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-14 xl:px-24 xl:max-w-2xl">
          <h2
            className="text-center text-4xl text-yellow-900 font-display font-semibold lg:text-left xl:text-5xl
                  xl:text-bold"
          >
            Log in
          </h2>
          <div className="mt-12">
            <form>
              ...
              <div className="mt-8">
                <div className="flex justify-between items-center">
                  ...
                  <div>
                    <Link
                      className="text-xs font-display font-semibold text-yellow-600 hover:text-yellow-800
                                      cursor-pointer"
                      to="#"
                    >
                      Forgot Password?
              ...
              <div className="mt-10">
                <button
                  className="bg-yellow-500 block text-gray-100 p-4 w-full rounded-full tracking-wide
                              font-semibold font-display focus:outline-none focus:shadow-outline hover:bg-yellow-600
                              shadow-lg mb-4"
                >
                    <img className="inline mr-2" src={Faceid}></img>
                    Faceid
                </button>
                  <button
                    type="submit"
            ...
            <div className="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
              ...
              <a className="cursor-pointer text-yellow-600 hover:text-yellow-800">
